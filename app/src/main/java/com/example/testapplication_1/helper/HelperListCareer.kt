package com.example.testapplication_1.helper
...
abstract class HelperListCareer(context: Context, private val recyclerView: RecyclerView , internal var buttonWidth:Int)
    ...
    override fun onChildDraw(
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE){
            ...
            if (dX < 0){
                ...
                traceSlattionX = dX * buffer.size.toFloat() * buttonWidth.toFloat() / itemView.width
                drawButton(c,itemView,buffer,pos,traceSlattionX)
            }
        }
        super.onChildDraw(c, recyclerView, viewHolder, traceSlattionX, dY, actionState, isCurrentlyActive)
    }
    ...
    private fun drawButton(
        ...
        pos: Int,
        traceSlattionX: Float
    ) {

        var right = itemView.right.toFloat()
        val dButtonWidth = -1 * traceSlattionX / buffer.size
